...
use Murky\BiblioBundle\Entity\Author;
use Murky\BiblioBundle\Form\AuthorType;
...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MurkyBiblioBundle:Author')->findAll();
     ...
     * @Method("POST")
     * @Template("MurkyBiblioBundle:Author:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('author', array('id' => $entity->getId())));
        }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MurkyBiblioBundle:Author')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MurkyBiblioBundle:Author:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('author', array('id' => $id)));
        }
